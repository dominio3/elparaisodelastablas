...
#~ Creo pantalla 
	pantalla=pygame.display.set_mode((921,716))
...
#Escribo texto
	...
	textonivel = fuente.render(str(puntaje), True, pygame.Color(0,0,0))
	pantalla.blit(textonivel, (750,630))
	volver = fuente.render(u'Presiona Enter para volver a jugar!!!', True, pygame.Color(0,0,0))
	pantalla.blit(volver, (430,30))
	pygame.display.flip()
...
def reloj(pantalla):
	for bucle in range[8,7,6,5,4,3,2,1,0]:
		fondo=pygame.image.load(os.path.join('imagenes','reloj',bucle,'.png'))
		pantalla.blit(fondo,(0,0))
		base=pantalla.copy()
